...
extern int SHARC_linkMasterInit( uint32_t *DMASlaveDestinationAddress );
extern int SHARC_linkSend( uint32_t stream, void *pSrcBuffer, void *pDestBuffer, uint8_t nBytesInElement, uint32_t nElementsInBuffer );
extern int SHARC_linkSend2D( uint32_t stream, void *pSrcBuffer, void *pDestBuffer, uint8_t nBytesInElement, uint32_t Xcount, uint32_t YCount );
