/*
 * File:           C:\Development\swe\bsp\audio\branches\1.1.0\package\Audio_EI3\Blackfin\Examples\ADSP-BF609\RecordPlayback\SigmaStudio\export\export_IC_1.h
 *
 * Created:        Monday, June 02, 2014 11:48:09 AM
 * Description:    RecordPlayback:IC 1 program data.
 *
...
0x00, 0x35, 0x08, 0x34, 0x00, 
0x00, 0x50, 0x09, 0x22, 0x00, 
...
0x21, 0x06, 0x41, 0x60, 0x05, 0x11, 0x01, 0xE7, 0xE7, 0xE6, 0xE6, 0xE7, 0x00, 0x03
};
...
/* Register Default - IC 1.PLL CLOCK DIVIDE BY 2 */
ADI_REG_TYPE PLLCLK_DIV_2[6] = {
0x00, 0x01, 0x00,0x00,0x22,0x01
};
...
void default_download_IC_1() {
	...
	//SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_IC_1, 0x4002, 6, PLLCLK_DIV_2 );
}
